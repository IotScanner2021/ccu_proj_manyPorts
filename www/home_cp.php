	...
	<body>
		...
		<div class="w10yy3-top">
		  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
		    ...
		    <div class="w3-right w3-hide-small">
		      ...
		      <a href="constructor.html" class="w3-bar-item w3-button">Results</a>
		    </div>
		  </div>
		 </div>
		...
		<div class="w3-content w3-padding" style="max-width:1564px">
		  ...
		  <div class="w3-container w3-padding-64" id="projects">
			...
			<input class="w3-input w3-section w3-border" type="text" placeholder="140.123.0.0/16" required name="ip">
			  ...
			  <div class="row">
					...
					<div class="col">
					 <div class="card text-center mb-3">
					  <div class="card-body" style="background-color:#ff0000">
					   <p class="card-text text-center fs-4 text-white" id="nas_num">10</p>
					  </div>
				...
				<div class="row mb-3">
				  <div class="col-sm-6">
					...
					<a href="site.php?device='nas'" class="btn btn-primary">See more</a>
				      </div>
				    </div>
				  </div>
				  <div class="col-sm-6">
					...
					<a href="site.php?device='printer'" class="btn btn-primary">See more</a>
				      </div>
				    </div>
				  </div>
				</div>
				...
				<div class="row mb-3">
				  <div class="col-sm-6">
					...
					<a href="site.php?device='router'" class="btn btn-primary">See more</a>
				      </div>
				    </div>
				  </div>
				  <div class="col-sm-6">
					...
					<a href="site.php?device='camera'" class="btn btn-primary">See more</a>
				      </div>
				    </div>
				  </div>
				</div>
